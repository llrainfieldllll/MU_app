...
# --- CONFIGURATION ---
st.set_page_config(layout="wide", page_title="Quant Scanner v19.0", page_icon="⚖️")
...
def get_signal(z, rank, vol):
    ...
    # LEGAL FIX: Changed "BUY/SELL" commands to Descriptive Observations
...
# --- MAIN UI ---
def main():
    # ADHD FIX: Sidebar Checklist to slow down decision making
    with st.sidebar:
        ...
        st.divider()
        st.caption("v19.0 Compliance Edition")

    st.title("⚖️ Quant Scanner v19.0")
    ...
    if run:
        with st.spinner(f"Analyzing {ticker}..."):
            ...
            with c_matrix:
                ...
                # LEGAL FIX: "Verdict" renamed to "Signal" and texts made descriptive
                matrix_rows = [
            ...
            with c_chart:
                ...
                # ADHD FIX: Helper tooltip to explain Density
    ...
    # LEGAL FIX: Mandatory Footer Disclaimer
    st.markdown("---")
    st.markdown("""
